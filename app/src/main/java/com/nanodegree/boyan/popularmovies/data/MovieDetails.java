...
public class MovieDetails implements IJsonDeserialize {
    ...
    public void getByJsonObject(JSONObject jsonObject) {
        ...
        genres = JsonHelpers.optArrayList(jsonObject, "genres", Genre.class);
        ...
        productionCompanies = JsonHelpers.optArrayList(jsonObject, "production_companies", ProductionCompany.class);
        productionCountries = JsonHelpers.optArrayList(jsonObject, "production_countries", ProductionCountry.class);
        releaseDate = jsonObject.optString("release_date");
        revenue = jsonObject.optInt("revenue");
        runtime = jsonObject.optInt("runtime");
        spokenLanguages = JsonHelpers.optArrayList(jsonObject, "spoken_languages", SpokenLanguage.class);
